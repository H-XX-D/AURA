...
def test_extract_metadata_compression_ratio():
    ...
    encoded = sidechannel.encode_metadata(
        compressed=b"X" * 250, compression_method=CompressionMethod.BRIO, original_size=1000
    )
...
def test_extract_metadata_performance():
    ...
    # Create test data
    encoded = sidechannel.encode_metadata(
        compressed=b"X" * 1000, compression_method=CompressionMethod.AURALITE, original_size=5000
    )
...
def test_analyze_metrics():
    ...
    print(
        f"   - Bandwidth saved: {metrics['bandwidth_saved_bytes']} bytes ({metrics['bandwidth_saved_percent']}%)"
    )
...
def test_get_performance_stats():
    ...
    encoded = sidechannel.encode_metadata(
        compressed=b"DATA", compression_method=CompressionMethod.AURALITE, original_size=100
    )

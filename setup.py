...
setup(
    ...
    project_urls={
        'Documentation': 'https://aura-protocol.readthedocs.io/',
        'Source': 'https://github.com/hendrixx-cnc/AURA',
        'Tracker': 'https://github.com/hendrixx-cnc/AURA/issues',
    ...
    packages=find_packages(exclude=['tests', 'tests.*', 'docs', 'tools', 'benchmarks']),
    ...
    entry_points={
        'console_scripts': [
            'aura-compress=aura_compression.cli.compress:main',
            'aura-decompress=aura_compression.cli.decompress:main',
            'aura-server=aura_compression.cli.server:main',
            'aura-benchmark=aura_compression.cli.benchmark:main',
        ],
    },
    cmdclass={
        'build_ext': BuildExt,

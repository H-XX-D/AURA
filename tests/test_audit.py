...
def test_entry_retrieval_with_filtering():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        alice_entries = logger.get_entries(
            AuditLogType.CLIENT_DELIVERED, user_id="alice", limit=100
        )
        ...
        bob_entries = logger.get_entries(AuditLogType.CLIENT_DELIVERED, user_id="bob", limit=100)
        ...
        morning_entries = logger.get_entries(
            AuditLogType.CLIENT_DELIVERED, session_id="morning", limit=100
        )
        ...
        alice_morning = logger.get_entries(
            AuditLogType.CLIENT_DELIVERED, user_id="alice", session_id="morning", limit=100
        )

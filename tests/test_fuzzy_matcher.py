...
from aura_compression.fuzzy_matcher import FuzzyMatch, FuzzyMatcher, create_fuzzy_matcher
...
def test_fuzzy_matcher_custom_parameters():
    ...
    matcher = FuzzyMatcher(
        min_similarity=0.75, max_distance=30, enable_caching=False, cache_size=500
    )
...
def test_find_similar_patterns_no_matches():
    ...
    text = "Hello World"
    patterns = ["Goodbye Universe", "Python Programming", "Data Science"]
...
def test_compress_similar_message_no_match():
    ...
    text = "Hello World"
    templates = ["Goodbye Universe", "Python Programming"]
...
def test_get_similarity_stats():
    ...
    matcher = FuzzyMatcher(
        min_similarity=0.90, max_distance=25, enable_caching=True, cache_size=500
    )
...
def test_create_fuzzy_matcher_factory():
    ...
    matcher = create_fuzzy_matcher(
        min_similarity=0.80, max_distance=40, enable_caching=True, cache_size=800
    )
